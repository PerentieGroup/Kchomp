    ...
    Object.keys(poolConfigs).forEach(function (coin) {
        ...
        handlers.auth = function (port, workerName, password, authCallback) {
            if (poolOptions.validateWorkerUsername !== true)
                ...
                console.log('poolOptions' + JSON.stringify(poolOptions))
                if (poolOptions.coin.privateChain) {
                    ...
                    pool.daemon.cmd('z_validateaddress', [String(workerName).split(".")[0]], function (results) {
                        ...
                        var isValid = results.filter(function (r) {
                            ...
                            } else if ((poolOptions.coin.sprout || poolOptions.coin.sprout > 0) && poolZAddressPrefix == 'zc') {
